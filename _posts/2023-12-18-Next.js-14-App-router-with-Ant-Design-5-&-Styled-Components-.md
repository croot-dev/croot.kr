...
<div style="display:flex;flex-direction:column;min-width:0px;margin-left:8px;width:100%;">Next.js 14 App Router 사용 환경에서 `Ant Design 5` 와 `Styled-Components` 를 설정하는 방법을 설명합니다.</div>
</div>
...
<div class="callout" style="display:flex;width:100%;border-radius:4px;background:rgb(241,241,239);padding: 16px 16px 16px 12px;">
<div style="display:flex;align-items:center;justify-content:center;height:24px;width:24px;border-radius:0.25em;flex-shrink:0;">💡</div>
<div style="display:flex;flex-direction:column;min-width:0px;margin-left:8px;width:100%;">**예제 환경<br />**- Engine: `Node 18.19.0 `<br />- Package Manager: `yarn 1.22.19`  </div>
</div>
...
<div class="callout" style="display:flex;width:100%;border-radius:4px;background:rgb(241,241,239);padding: 16px 16px 16px 12px;">
<div style="display:flex;align-items:center;justify-content:center;height:24px;width:24px;border-radius:0.25em;flex-shrink:0;">💡</div>
<div style="display:flex;flex-direction:column;min-width:0px;margin-left:8px;width:100%;">위 방식대로 잘 안된다면 아래 ant-design 에서 제공하는 예제 소스를 이용해보시길..<br />[🔗 ant-design 에서 제공하는 예제 소스코드](https://github.com/ant-design/ant-design-examples/tree/main/examples)</div>
</div>
