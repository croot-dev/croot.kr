...
edited: 2024-06-03
category: [기술]
tags: [npm,package,개발환경,config,vue,pnpm,storybook]
---
...
<div style="display:flex;flex-direction:column;min-width:0px;margin-left:8px;width:100%;">`@ui-component/elements` 의 배포 내용이 변경될 경우, 서버를 다시 실행해주어야 적용됨.</div>
</div>
